...
import RawMaterialRouter from "./routes/rawMaterial.route.js";
import ProductionProcess from "./routes/productionProcess.router";
...
app.use("/production-process", ProductionProcess);
